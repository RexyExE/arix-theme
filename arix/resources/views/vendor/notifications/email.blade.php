...
$defaultArixMail = config('arix') ?? [];
if (!isset($siteConfiguration) || !is_array($siteConfiguration)) {
    $siteConfiguration = ['arix' => $defaultArixMail];
} elseif (!isset($siteConfiguration['arix'])) {
    $siteConfiguration['arix'] = $defaultArixMail;
} else {
    $siteConfiguration['arix'] = array_merge($defaultArixMail, $siteConfiguration['arix']);
}

// Ensure default fallback values for critical keys
$siteConfiguration['arix']['mail_backgroundColor'] = $siteConfiguration['arix']['mail_backgroundColor'] ?? '#F5F5FF';
$siteConfiguration['arix']['mail_mode'] = $siteConfiguration['arix']['mail_mode'] ?? 'light';
$siteConfiguration['arix']['mail_color'] = $siteConfiguration['arix']['mail_color'] ?? '#4a35cf';
$siteConfiguration['arix']['mail_logo'] = $siteConfiguration['arix']['mail_logo'] ?? '/arix/Arix.png';
$siteConfiguration['arix']['mail_logoFull'] = $siteConfiguration['arix']['mail_logoFull'] ?? false;
$siteConfiguration['arix']['mail_discord'] = $siteConfiguration['arix']['mail_discord'] ?? '';
$siteConfiguration['arix']['mail_twitter'] = $siteConfiguration['arix']['mail_twitter'] ?? '';
$siteConfiguration['arix']['mail_facebook'] = $siteConfiguration['arix']['mail_facebook'] ?? '';
$siteConfiguration['arix']['mail_instagram'] = $siteConfiguration['arix']['mail_instagram'] ?? '';
$siteConfiguration['arix']['mail_linkedin'] = $siteConfiguration['arix']['mail_linkedin'] ?? '';
$siteConfiguration['arix']['mail_youtube'] = $siteConfiguration['arix']['mail_youtube'] ?? '';
$siteConfiguration['arix']['mail_billing'] = $siteConfiguration['arix']['mail_billing'] ?? '';
$siteConfiguration['arix']['mail_support'] = $siteConfiguration['arix']['mail_support'] ?? '';
$siteConfiguration['arix']['mail_status'] = $siteConfiguration['arix']['mail_status'] ?? '';
