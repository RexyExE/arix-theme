...
@section('content')
    <form action="{{ route('admin.arix.styling') }}" method="POST" class="content-box">
        ...
        >
            ...
            />
            <x-arix.switch 
                id="arix:loginGradient"
                name="arix:loginGradient"
                :value="$loginGradient"
                label="Login background gradient overlay"
                helpText="Enable subtle gradient overlay over the login page background."
            />
        </x-arix.form-wrapper>
        ...
        >
            <div class="input-field">
                ...
                >
                    ...
                    <option value="plus_jakarta_sans" {{ $font === 'plus_jakarta_sans' ? 'selected' : '' }}>Plus Jakarta Sans (Silk Veil)</option>
                    <option value="jetbrains_mono" {{ $font === 'jetbrains_mono' ? 'selected' : '' }}>JetBrains Mono</option>
