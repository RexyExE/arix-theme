...
class ArixController extends Controller
{
    ...
    public function index(): View
    {
        return $this->view->make('admin.arix.index', [
            ...
            'billing' => $this->settings->get('settings::arix:billing', config('arix.billing', 'https://billing.weijers.one')),
            'status' => $this->settings->get('settings::arix:status', config('arix.status', 'https://status.weijers.one')),
        ]);
    }
