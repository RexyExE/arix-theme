...
<html>
    <head>
        ...
        @section('meta')
            ...
            <!-- meta data -->
            <!--
            <link rel="apple-touch-icon" sizes="180x180" href="/favicons/apple-touch-icon.png?v=010101">
        ...
        <style>
            ...
            :root{
                <?php if (!empty($siteConfiguration['arix']['borderInput']) && ($siteConfiguration['arix']['borderInput'] === 'true' || $siteConfiguration['arix']['borderInput'] === true || $siteConfiguration['arix']['borderInput'] === 1 || $siteConfiguration['arix']['borderInput'] === '1')) {
...
';  
            ...
            <?php if (!empty($siteConfiguration['arix']['backdrop']) && ($siteConfiguration['arix']['backdrop'] === true || $siteConfiguration['arix']['backdrop'] === 'true' || $siteConfiguration['arix']['backdrop'] === 1 || $siteConfiguration['arix']['backdrop'] === '1')) {
