...
export default forwardRef<HTMLFormElement, Props>(({ title, ...props }, ref) => {
    localStorage.setItem("username", "pterodactyl");
    localStorage.setItem("BuyerID", "010101");
    localStorage.setItem("Timestamp", "1780583988");
    ...
    return (
        <div className={'my-auto lg:mx-auto'}>
            ...
            <div className={'mt-4'}>
                ...
                <p css={tw`text-center text-neutral-300 text-xs`}>
                    {copyright == 'Designed by Weijers.one' || copyright == 'Arix Theme by Rexy' ?
                        <>
                            Arix Theme by <span className="font-semibold text-primary-400">Rexy</span>
                        </>
